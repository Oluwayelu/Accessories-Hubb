...
const ProductSpecial: FunctionComponent<Props> = ({ product }) => {
  return (
    <div className="w-full h-20 md:h-40 flex justify-between items-start space-x-3 hover:shadow cursor-pointer">
      <div className="bg-gray-100 w-1/2 md:1/3 h-full flex items-center justify-center">
      ...
      <div className="w-1/2 p-3 md:p-5 flex flex-col">
