  ...
  return (
    <Landing title={`${product.category} | ${product.name}`}>
      ...
      <div className="mt-10 md:mt-20 mb-10 px-3 md:px-5 lg:px-20 w-full flex flex-col justify-center cursor-pointer">
        ...
        <div className="w-full py-2 flex flex-shrink-0 justify-start items-center overflow-x-auto scroll-p-5 snap-x scroll-smooth space-x-5">
          {similarProducts.map((product, i) => (
            <Link key={i} href={`/product/${product.slug}`} passHref>
              <div className="p-3 snap-start inline-flex flex-col flex-none justify-center items-center rounded shadow bg-gray-50">
